...
public class CommandManager {
	...
	public ArrayList<Map<String, String>> getArgsFromList (String CommandListName) {
		if (CommandConf == null)
			reload();
		
		ArrayList<Map <String, String>> cmd = new ArrayList<Map <String, String>>();
		
		for (String x: CommandConf.getSection(PluginName + "." + CommandListName + ".args").getKeys(false)) {
			if (!x.equals("syntax") && !x.equals("description")) {
				Map <String, String> hash = new HashMap<String, String>();
				hash.put("name", x);
				hash.put("syntax", CommandConf.getString(PluginName + "." + CommandListName + ".args." + x + ".syntax"));
				hash.put("description", CommandConf.getString(PluginName + "." + CommandListName + ".args." + x + ".description"));
